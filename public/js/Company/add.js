...
new Vue({
    ...
    methods: {
        ...
        getAddress() {
            ...
            this.address = "";
            axios
                .post(APP_URL + `getAddressFromPostCode`, {
                ...
                .catch((error) => {
                    ...
                    this.$swal(
                        ...
                        this.selectedLanguage == "en"
                            ? "Invalid zip code or house number"
                            : "Ongeldige postcode of huisnummer",
                        "error"
                    );
                });
            ...
            if (this.phoneDetails && !this.phoneDetails.isValid) {
                this.$swal(
                    ...
                    this.selectedLanguage == "en"
                        ...
                        : "Voeg een geldig telefoonnummer toe",
                    "error"
                );
                return null;
            }
                ...
                .then((response) => {
                    this.$swal(
                        ...
                        this.selectedLanguage == "en"
                            ...
                            : "Bedrijf heeft succesvol toegevoegd",
                        "success"
                    );
                    this.email = "";
                    this.pass = "";
