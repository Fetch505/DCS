        ...
        <div class="w-full max-w-lg">
            ...
            <div class="glass-effect rounded-2xl shadow-2xl p-8 fade-in" style="animation-delay: 0.2s;">
                ...
                <form method="POST" action="{{ route('signup') }}" class="space-y-6" 
                    ...
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="btn-hover w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white  bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 mt-8">
