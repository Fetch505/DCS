      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            {{ Form::model($category,['route' => ['methodCategory.update',$category->id], 'method' => 'PUT' ,'data-parsley-validate' => '']) }}
              ...
              <div class="inline pull-right">
                ...
                <a href="{{ route('methodCategory.index') }}" type="button" class="btn btn-danger">@lang('Company_Admin/dashboard.Cancel')</a>
              </div>
              {{ Form::close() }}
...
@endsection
  ...
  <script src="{{asset('public/js/Method/edit.js')}}"></script>
  @endsection
