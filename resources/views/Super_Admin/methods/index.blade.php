  ...
  <div id="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <a href="{{route('method.create')}}", class="btn btn-primary btn-sm" style="margin-top: 30px; margin-left: 15px;"><i class="fa fa-plus" aria-hidden="true"></i> @lang('Company_Admin/dashboard.Add New')</a>
      </div>
    </div>
                          ...
                          @foreach ($methods as $key => $method)
                            <tr>
                                ...
                                <td style="text-align:center">
                                  <a href="#" title="View Video" class="view-icon" data-toggle="modal" data-target="#myModal" data-video-url="{{ $method->video_url }}" >
                                    <i class="fa fa-eye view-icon" style="color:blue"></i>
                                  </a>
                                  <a href="{{route('method.edit',$method->id)}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" style="color:green;"></i></a>
                                  <a href="{{route('method.delete',$method->id)}}" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-times" style="color:red;"></i></a>
                                </td>
                            </tr>
                          @endforeach
                        </tbody>
