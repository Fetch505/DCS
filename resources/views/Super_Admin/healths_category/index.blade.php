  ...
  <div id="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <a href="{{route('healthCategory.create')}}", class="btn btn-primary btn-sm" style="margin-top: 30px; margin-left: 15px;"><i class="fa fa-plus" aria-hidden="true"></i> @lang('Company_Admin/dashboard.Add New')</a>
      </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    @lang('common.List of health categories')
                </div>
                <!-- /.panel-heading -->
                          ...
                          @foreach ($category as $key => $category)
                            <tr>
                                ...
                                <td style="text-align:center">
                                  <a href="{{route('healthCategory.edit',$category->id)}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-square-o" style="color:green;"></i></a>
                                </td>
                            </tr>
                          @endforeach
                        </tbody>
