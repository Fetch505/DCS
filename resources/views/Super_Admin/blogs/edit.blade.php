        ...
        <div class="row">
          ...
          <div class="col-md-4 text-right">
              <br>
                ...
                <a href="{{ route('blogs.show', $blog)}}" class="btn btn-primary btn-sm my-3"><i class="fa fa-eye view-icon" style="color:white"></i></a>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                  <div class="panel-heading">
                      @lang('common.Edit blog')
                  </div>
                  <!-- /.panel-heading -->
                  <div class="panel-body">
                    <form name="myForm" method="POST" @submit.prevent="doSubmit" action="{{ route('blogs.update',$blog->id) }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group">
                          ...
                          <div id="editor"  style="height:600px;font-size:1.4rem;">{!! $blog->content !!}</div> 
                          <input id="content" name="content" type="hidden">                 
                      </div>

                      <div class="form-group">
                        @if($blog->featured_image)
                          <img src="{{ asset('storage/app/' . $blog->featured_image) }}" style="width:300px" alt="Placeholder Image">
                        @else
