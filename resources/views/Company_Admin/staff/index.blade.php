    ...
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{ route('staff.create') }}", class="btn btn-primary btn-sm"
                style="margin-top: 30px; margin-left: 15px;"><i class="fa fa-plus" aria-hidden="true"></i>@lang('Company_Admin/dashboard.Add New')</a>
        </div>
    </div>
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('staff.show', $user->id) }}" class="me-2" data-bs-toggle="tooltip"
                                    title="@lang('Company_Admin/dashboard.View')">
                                    <i class="fa fa-eye text-primary"></i>
                                </a>
                                <a href="{{ route('staff.edit', $user->id) }}" class="me-2" data-bs-toggle="tooltip"
                                    title="@lang('Company_Admin/dashboard.Edit')">
