        ...
        <div class="row" id="app">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <form action="{{ route('getErpReport') }}" method="post">
                        @csrf
                        <div class="row">
                            <br>
                            <div class="col-md-2" >
                    ...
                    <div class="panel-body">
                        <table width="100%" id="table" class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('Company_Admin/dashboard.Attendance')</th>
                            ...
                            @if(session('worker_report'))
                                @foreach(session('worker_report') as $key => $detail)
                                    <tr>
                                        ...
                                        <td>{{ date('Y-m-d',strtotime($detail->input_date)) }}</td>
                                        <td>{{ optional($detail)->hours }}</td>
